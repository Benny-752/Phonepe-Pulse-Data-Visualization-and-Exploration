...
st.sidebar.header(":heavy_dollar_sign: :violet[**PhonePe Data Visualization**] :heavy_dollar_sign:")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\user\anaconda3\envs\ml\Statenames.csv')
            df1.State = df2
